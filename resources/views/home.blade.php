...
@section('main')
            ...
            <div class="flex justify-center space-x-4">
                <div class="bg-secondary opacity-75 rounded-lg text-white px-7 py-6 space-y-2">
                    <div class="flex justify-between space-x-4 mb-4 items-center">
                        <input id="weatCity" type="text" class="w-full text-xs opacity-25 bg-black rounded-lg p-3 text-white placeholder-white" placeholder="Gowa">
                    ...
                    <div classs="">
                        ...
                        <h2 class="text-4xl font-bold suhu"> 25 C</h2>
        ...
        <section class="container">
            ...
            <div class="flex justify-center gap-6 flex-wrap" >
                ...
                <div class="pelayanan">
                    <div class="pelayanan-content">
                        <svg width="80" height="80" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M63.714 35.399c-1.464 0-2.744 1.263-2.744 2.706v32.482H10.487V16.632h36.4c1.462 0 2.743-1.263 2.743-2.707s-1.28-2.707-2.744-2.707H7.744C6.28 11.218 5 12.301 5 13.925v59.368C5 74.737 6.28 76 7.744 76h55.97c1.463 0 2.743-1.263 2.743-2.707V38.105c0-1.443-1.28-2.706-2.743-2.706z" fill="#BFBFBF"/><path d="M59.507 11.038c-1.098-.903-2.927-.722-3.841.36L27.132 44.783c-.366.36-.549.722-.549 1.263l-2.56 13.173c-.183 1.083.182 1.985.914 2.707.549.36 1.098.541 1.646.541.366 0 .732 0 1.098-.18l11.889-5.414c.366-.18.731-.36.914-.722l28.351-33.383c.549-.541.732-1.263.549-1.985 0-.722-.366-1.444-.915-1.805l-8.962-7.94zM37.009 52l-6.585 2.887 1.464-7.218 26.155-30.857 5.122 4.33L37.009 52zM74.14 12.662l-9.878-8.12c-1.097-.903-2.926-.722-3.84.36-.915 1.083-.732 2.888.365 3.79l9.877 8.12c.549.361 1.098.722 1.83.722.731 0 1.645-.36 2.194-.902a3.259 3.259 0 00-.549-3.97zM18.535 24.572c-1.463 0-2.743 1.263-2.743 2.707 0 1.443 1.28 2.706 2.743 2.706h12.987c1.463 0 2.743-1.263 2.743-2.706 0-1.444-1.28-2.707-2.743-2.707H18.535z" fill="#BFBFBF"/></svg>
