...
@section('main')
    ...
    <section class="container flex lg:space-x-6">
        ...
        <div class="w-full space-y-10 px-4 pb-10">
            <h3 class="text-header-2 text-dark"> Sistem Pengendali Intern</h3>
            <div class="space-y-5">
                <h3 class="text-title">Pembangunan Zona Integritas Menuju Wilayah Bebas dari Korupsi (WBK) dan Wilayah Birokrasi Bersih dan Melayani (WBBM)</h3>
