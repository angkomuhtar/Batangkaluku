        ...
        <div class="element-box">
            <form id="formValidate" action="{{$action}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input name="image" class="form-control" id="imgInp" type="file" accept="image/*" data-error="image is required"
                           {{$data->id ? '' : 'required'}}>
                    <div class="help-block form-text with-errors form-control-feedback">

                    </div>
                    <div id="img-preview-container" class="pt21">
                        <img class="border img-thumbnail" src="{{!$data->id ? asset('assets/img/onboarding1.jpg') : asset('storage/'.$data->image)}}" alt=""
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"
                                               name="text_header"
                                               data-error="text header is required"
                                               placeholder="Enter Text header"
                                        >{{$data->text_header ?? old('text_header')}}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"
                                                  name="text_content"
                                                  data-error="text konten is required"
                                                  placeholder="Enter Text konten"
                                        >{{$data->text_content ?? old('text_content')}}</textarea>
                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"
                                                  ...
                                                  data-error="text header is required"
                                                  placeholder="Enter Text header"
                                        >{{$data->text_header_en ?? old('text_header_en')}}</textarea>
                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
                                    <div class="form-group">
                                        <label for=""> Text Konten</label>
                                        <textarea class="form-control"
                                                  ...
                                                  data-error="text konten is required"
                                                  placeholder="Enter Text konten"
                                        >{{$data->text_content_en ?? old('text_content_en')}}</textarea>
                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
                                </div>
                            </div>
