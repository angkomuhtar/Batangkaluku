                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input name="rank" type="text" class="form-control"
                                               data-error="pangkat golongan is required"
                                               value="{{$data->rank ?? old('rank')}}"
                        ...
                        <fieldset class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for=""> Pangkat / Golongan </label>
                                        <input name="rank_en" type="text" class="form-control"
                                               data-error="pangkat golongan is required"
                                               value="{{$data->rank_en ?? old('rank_en')}}"
                                               placeholder="Pangkat / Golongan"
                                               >
                                        <div class="help-block form-text with-errors form-control-feedback"></div>
                                    </div>
                                    <div class="form-group">
                                        <label for=""> Jabatan </label>
                                        <input name="position_en" type="text" class="form-control"
                                               data-error="jabatan is required"
