        ...
        <div class="element-box">
            <form id="formValidate" action="{{$action}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input name="content" class="form-control" id="imgInp" type="file"
                           accept="{{$type === 'foto' ? 'image' : 'video'}}/*"
                    ...
                    @if ($type === 'foto')
                        <div id="img-preview-container" class="pt-2">
                            <img class="border img-thumbnail"
                                 src="{{!$data->id ? asset('assets/img/onboarding1.jpg') : asset('storage/'.$data->content)}}"
                                 alt=""
                                 id="imgPvw" style="max-height: 500px">
                        </div>
                    @else
                        <div id="img-preview-container" class="pt-2">
                            <video class="border img-thumbnail"
                                   src="{{!$data->id ? '' : asset('storage/'.$data->content)}}" id="imgPvw"
                                   style="max-height: 500px" controls></video>
                        </div>
                    @endif
                </div>
                <div class="row">
