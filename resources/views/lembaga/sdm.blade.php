...
@section('main')
    ...
    <section class="content">
        ...
        <div class="hidden fixed z-50 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="modal-profil">
                        ...
                        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="flex space-x-2">
                                    <div class="rounded-full bg-secondary bg-opacity-25 flex items-center justify-center h-10 w-10">
                                        <svg class="h-6 w-6 text-secondary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                        </svg>
                                    </div>
                                    <h3 class="text-lg leading-6 font-medium text-gray-900 text-center sm:text-left mb-2 flex flex-col justify-center" id="modal-title">
                                ...
                                <div class="mt-4 ml-3 grid gap-y-3">
                                    <div class="grid grid-cols-5 gap-x-3">
                                        ...
                                        <p class="text-gray-500 col-span-3">Dr. SHABIR </p>
                                    </div>
                                    <div class="grid grid-cols-5 gap-x-3">
                            ...
                            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                <button id="modal-close" type="button" class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                                    Tutup
                                </button>
                            </div>
                        </div>
                                    ...
                                    @foreach ($row->humanResources->where('level_id',1)->sortBy('order_id') AS $sdm)
                                        <div class="bg-white rounded-md p-2">
                                            <div class="relative group">
                                                <img src="{{asset('storage/'.$sdm->image)}}" alt="" class="rounded-t-md object-center">
                                                <div class="invisible transition-all ease-in transform absolute left-0 bottom-0 right-0 w-full bg-blue-300 group-hover:visible flex flex-col justify-center items-center p-5">
                                                    <button class="my-modal text-white">
